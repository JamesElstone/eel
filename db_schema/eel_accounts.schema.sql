...
CREATE TABLE `companies_house_accounts_submissions` (
  ...
  `accounts_artifact_id` bigint(20) DEFAULT NULL,
  `accounts_validation_run_id` bigint(20) DEFAULT NULL,
  ...
  KEY `idx_ch_accounts_submission_artifact` (`accounts_artifact_id`),
  KEY `idx_ch_accounts_submission_validation` (`accounts_validation_run_id`),
...
CREATE TABLE `hmrc_ct600_submissions` (
  ...
  `hmrc_ct_filing_approval_id` bigint(20) DEFAULT NULL,
  `hmrc_ct_filing_approval_hash` char(64) CHARACTER SET ascii COLLATE ascii_bin DEFAULT NULL,
  ...
  `computation_validation_run_id` bigint(20) DEFAULT NULL,
  ...
  KEY `idx_hmrc_ct600_filing_approval` (`hmrc_ct_filing_approval_id`),
  KEY `idx_hmrc_ct600_accounts_artifact` (`accounts_artifact_id`),
  KEY `idx_hmrc_ct600_accounts_validation` (`accounts_validation_run_id`),
  KEY `idx_hmrc_ct600_computation_validation` (`computation_validation_run_id`),
...
--
-- Table structure for table `corporation_tax_line_treatment_decisions`
--

DROP TABLE IF EXISTS `corporation_tax_line_treatment_decisions`;
CREATE TABLE `corporation_tax_line_treatment_decisions` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `company_id` int(11) NOT NULL,
  `accounting_period_id` int(11) NOT NULL,
  `journal_id` bigint(20) NOT NULL,
...
--
-- Table structure for table `asset_impairment_entries`
--

DROP TABLE IF EXISTS `asset_impairment_entries`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `asset_impairment_entries` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `asset_id` bigint(20) NOT NULL,
  `accounting_period_id` int(11) NOT NULL,
...
CREATE TABLE `ct600_generated_artifacts` (
  ...
  `source_manifest_json` longtext DEFAULT NULL,
  `ct_filing_basis_hash` char(64) CHARACTER SET ascii COLLATE ascii_bin DEFAULT NULL,
  `accounts_run_id` bigint(20) DEFAULT NULL,
  `accounts_artifact_id` bigint(20) DEFAULT NULL,
  `accounts_validation_run_id` bigint(20) DEFAULT NULL,
  `accounts_sha256` char(64) CHARACTER SET ascii COLLATE ascii_bin DEFAULT NULL,
  `computation_run_id` bigint(20) DEFAULT NULL,
  `computation_validation_run_id` bigint(20) DEFAULT NULL,
  `computations_sha256` char(64) CHARACTER SET ascii COLLATE ascii_bin DEFAULT NULL,
  `rim_package_id` bigint(20) DEFAULT NULL,
  `rim_form_version` varchar(64) DEFAULT NULL,
  `rim_artifact_version` varchar(64) DEFAULT NULL,
  `rim_package_sha256` char(64) CHARACTER SET ascii COLLATE ascii_bin DEFAULT NULL,
  `mapping_profile_id` bigint(20) DEFAULT NULL,
  `mapping_revision_no` int(11) DEFAULT NULL,
  `mapping_content_hash` char(64) CHARACTER SET ascii COLLATE ascii_bin DEFAULT NULL,
  `serializer_version` varchar(64) DEFAULT NULL,
  `package_version` varchar(64) DEFAULT NULL,
  `irmark` varchar(255) DEFAULT NULL,
  `validation_json` longtext DEFAULT NULL,
  ...
  `generated_at` datetime NOT NULL DEFAULT current_timestamp(),
  PRIMARY KEY (`id`),
  UNIQUE KEY `uq_ct600_generated_artifact_source_manifest` (`company_id`,`accounting_period_id`,`ct_period_id`,`source_manifest_sha256`),
  KEY `idx_ct600_generated_artifact_hash` (`output_sha256`),
  KEY `idx_ct600_generated_artifact_current` (`company_id`,`accounting_period_id`,`ct_period_id`,`filing_approval_id`,`id`),
  KEY `idx_ct600_generated_artifact_source` (`company_id`,`accounting_period_id`,`ct_period_id`,`filing_approval_id`,`accounts_run_id`,`computation_run_id`),
  KEY `idx_ct600_generated_hmrc_approval` (`hmrc_ct_filing_approval_id`),
  KEY `idx_ct600_generated_accounts_artifact` (`accounts_artifact_id`),
  KEY `idx_ct600_generated_accounts_validation` (`accounts_validation_run_id`),
  KEY `idx_ct600_generated_computation_validation` (`computation_validation_run_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
DROP TABLE IF EXISTS `hmrc_ct_filing_approval_period_bases`;
DROP TABLE IF EXISTS `ixbrl_validation_runs`;
DROP TABLE IF EXISTS `ixbrl_accounts_artifacts`;
DROP TABLE IF EXISTS `hmrc_ct_filing_approvals`;
CREATE TABLE `ixbrl_accounts_artifacts` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `generation_run_id` bigint(20) NOT NULL,
  `company_id` int(11) NOT NULL,
  `accounting_period_id` int(11) NOT NULL,
  `filing_approval_id` bigint(20) NOT NULL,
  `filing_approval_hash` char(64) CHARACTER SET ascii COLLATE ascii_bin NOT NULL,
  ...
  `taxonomy_profile` varchar(100) DEFAULT NULL,
  `taxonomy_package_id` bigint(20) DEFAULT NULL,
  `taxonomy_package_sha256` char(64) CHARACTER SET ascii COLLATE ascii_bin DEFAULT NULL,
  ...
  `created_at` datetime NOT NULL DEFAULT current_timestamp(),
  PRIMARY KEY (`id`),
  UNIQUE KEY `uq_ixbrl_accounts_artifact_build` (`generation_run_id`,`authority`,`filing_kind`,`profile_fingerprint`,`render_model_sha256`),
  KEY `idx_ixbrl_accounts_artifact_current` (`company_id`,`accounting_period_id`,`authority`,`filing_kind`,`profile_key`,`id`),
  ...
  CONSTRAINT `fk_ixbrl_accounts_artifact_run` FOREIGN KEY (`generation_run_id`) REFERENCES `ixbrl_generation_runs` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_ixbrl_accounts_artifact_company` FOREIGN KEY (`company_id`) REFERENCES `companies` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_ixbrl_accounts_artifact_period` FOREIGN KEY (`accounting_period_id`) REFERENCES `accounting_periods` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_ixbrl_accounts_artifact_approval` FOREIGN KEY (`filing_approval_id`) REFERENCES `ixbrl_accounts_filing_approvals` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `chk_ixbrl_accounts_artifact_authority` CHECK (`authority` in ('HMRC','COMPANIES_HOUSE')),
  CONSTRAINT `chk_ixbrl_accounts_artifact_filing_kind` CHECK (`filing_kind` in ('ordinary','original','revised')),
  CONSTRAINT `chk_ixbrl_accounts_artifact_authority_kind` CHECK ((`authority` = 'HMRC' and `filing_kind` = 'ordinary') or (`authority` = 'COMPANIES_HOUSE' and `filing_kind` in ('original','revised')))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
CREATE TABLE `ixbrl_validation_runs` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `accounts_artifact_id` bigint(20) DEFAULT NULL,
  `computation_run_id` int(11) DEFAULT NULL,
  `company_id` int(11) NOT NULL,
  ...
  CONSTRAINT `fk_ixbrl_validation_accounts_artifact` FOREIGN KEY (`accounts_artifact_id`) REFERENCES `ixbrl_accounts_artifacts` (`id`) ON DELETE CASCADE ON UPDATE RESTRICT,
  CONSTRAINT `fk_ixbrl_validation_computation_run` FOREIGN KEY (`computation_run_id`) REFERENCES `corporation_tax_computation_runs` (`id`) ON DELETE CASCADE ON UPDATE RESTRICT,
  CONSTRAINT `fk_ixbrl_validation_company` FOREIGN KEY (`company_id`) REFERENCES `companies` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_ixbrl_validation_period` FOREIGN KEY (`accounting_period_id`) REFERENCES `accounting_periods` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_ixbrl_validation_ct_period` FOREIGN KEY (`ct_period_id`) REFERENCES `corporation_tax_periods` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `chk_ixbrl_validation_single_target` CHECK ((`accounts_artifact_id` is not null and `computation_run_id` is null) or (`accounts_artifact_id` is null and `computation_run_id` is not null)),
  CONSTRAINT `chk_ixbrl_validation_authority` CHECK (`authority` in ('HMRC','COMPANIES_HOUSE'))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
CREATE TABLE `hmrc_ct_filing_approvals` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `company_id` int(11) NOT NULL,
  `accounting_period_id` int(11) NOT NULL,
  `accounts_filing_approval_id` bigint(20) NOT NULL,
  `accounts_filing_approval_hash` char(64) CHARACTER SET ascii COLLATE ascii_bin NOT NULL,
  `return_authorisation_id` bigint(20) NOT NULL,
  ...
  `approval_note` text DEFAULT NULL,
  `approved_at` datetime NOT NULL DEFAULT current_timestamp(),
  `legacy_combined_approval_id` bigint(20) DEFAULT NULL,
  `created_at` datetime NOT NULL DEFAULT current_timestamp(),
  PRIMARY KEY (`id`),
  ...
  CONSTRAINT `fk_hmrc_ct_filing_approval_company` FOREIGN KEY (`company_id`) REFERENCES `companies` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_hmrc_ct_filing_approval_period` FOREIGN KEY (`accounting_period_id`) REFERENCES `accounting_periods` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_hmrc_ct_filing_approval_accounts` FOREIGN KEY (`accounts_filing_approval_id`) REFERENCES `ixbrl_accounts_filing_approvals` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `fk_hmrc_ct_filing_approval_authorisation` FOREIGN KEY (`return_authorisation_id`) REFERENCES `ct600_return_authorisations` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `fk_hmrc_ct_filing_approval_legacy` FOREIGN KEY (`legacy_combined_approval_id`) REFERENCES `ixbrl_accounts_filing_approvals` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
CREATE TABLE `ct_period_filing_bases` (
  ...
  KEY `idx_ct_period_filing_basis_hmrc_approval` (`hmrc_ct_filing_approval_id`,`ct_period_id`),
  ...
  CONSTRAINT `fk_ct_period_filing_basis_hmrc_approval` FOREIGN KEY (`hmrc_ct_filing_approval_id`) REFERENCES `hmrc_ct_filing_approvals` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE,
...
CREATE TABLE `hmrc_ct_filing_approval_period_bases` (
  `hmrc_ct_filing_approval_id` bigint(20) NOT NULL,
  `ct_period_filing_basis_id` bigint(20) NOT NULL,
  `ct_period_id` int(11) NOT NULL,
  `basis_hash` char(64) CHARACTER SET ascii COLLATE ascii_bin NOT NULL,
  `created_at` datetime NOT NULL DEFAULT current_timestamp(),
  ...
  CONSTRAINT `fk_hmrc_ct_approval_basis_approval` FOREIGN KEY (`hmrc_ct_filing_approval_id`) REFERENCES `hmrc_ct_filing_approvals` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `fk_hmrc_ct_approval_basis_basis` FOREIGN KEY (`ct_period_filing_basis_id`) REFERENCES `ct_period_filing_bases` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `fk_hmrc_ct_approval_basis_ct_period` FOREIGN KEY (`ct_period_id`) REFERENCES `corporation_tax_periods` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
ALTER TABLE `companies_house_accounts_submissions`
  ADD CONSTRAINT `fk_ch_accounts_submission_artifact` FOREIGN KEY (`accounts_artifact_id`) REFERENCES `ixbrl_accounts_artifacts` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_ch_accounts_submission_validation` FOREIGN KEY (`accounts_validation_run_id`) REFERENCES `ixbrl_validation_runs` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
ALTER TABLE `ct600_generated_artifacts`
  ADD CONSTRAINT `fk_ct600_generated_hmrc_approval` FOREIGN KEY (`hmrc_ct_filing_approval_id`) REFERENCES `hmrc_ct_filing_approvals` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_ct600_generated_accounts_artifact` FOREIGN KEY (`accounts_artifact_id`) REFERENCES `ixbrl_accounts_artifacts` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_ct600_generated_accounts_validation` FOREIGN KEY (`accounts_validation_run_id`) REFERENCES `ixbrl_validation_runs` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_ct600_generated_computation_validation` FOREIGN KEY (`computation_validation_run_id`) REFERENCES `ixbrl_validation_runs` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
ALTER TABLE `hmrc_ct600_submissions`
  ADD CONSTRAINT `fk_hmrc_ct600_filing_approval` FOREIGN KEY (`hmrc_ct_filing_approval_id`) REFERENCES `hmrc_ct_filing_approvals` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_hmrc_ct600_accounts_artifact` FOREIGN KEY (`accounts_artifact_id`) REFERENCES `ixbrl_accounts_artifacts` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_hmrc_ct600_accounts_validation` FOREIGN KEY (`accounts_validation_run_id`) REFERENCES `ixbrl_validation_runs` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_hmrc_ct600_computation_validation` FOREIGN KEY (`computation_validation_run_id`) REFERENCES `ixbrl_validation_runs` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
...
--
-- Cached canonical Year End review bundles. Approval history remains in
-- year_end_review_acknowledgements and year_end_audit_log.
--

DROP TABLE IF EXISTS `year_end_section_review_bundles`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `year_end_section_review_bundles` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `company_id` int(11) NOT NULL,
  `accounting_period_id` int(11) NOT NULL,
  `check_code` varchar(100) NOT NULL,
...
INSERT IGNORE INTO `schema_migrations` (`migration`) VALUES
  ('2026_08_03_001_authority_specific_ixbrl_artifacts.sql');
INSERT IGNORE INTO `schema_migrations` (`migration`) VALUES
...
INSERT IGNORE INTO `schema_migrations` (`migration`) VALUES
  ('2026_08_03_005_ixbrl_validation_target_fk_repair.sql');
