...
CREATE TABLE `ixbrl_fact_mappings` (
  ...
  `label` varchar(255) NOT NULL,
  `value_type` enum('numeric','text','date','boolean') NOT NULL,
  `calculation_type` enum('nominal_subtype_sum','nominal_account_sum','manual','derived','company_field','period_field','disclosure_field','disclosure_statement','absence_statement','application_value','fixed_marker','director_loan_statement','director_loan_numeric','companies_house_revision_explanation') NOT NULL,
...
('companies_house_revision_explanation','bus:StatementRespectsInWhichPreviouslyFiledReportDidNotComplyWithCompaniesAct2006','http://xbrl.frc.org.uk/cd/2026-01-01/business','StatementRespectsInWhichPreviouslyFiledReportDidNotComplyWithCompaniesAct2006','Companies House revision explanation','text','companies_house_revision_explanation',NULL,1,'duration',NULL,NULL,'duration',NULL,0,0,65,1),
