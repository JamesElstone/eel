ALTER TABLE ixbrl_accounts_disclosures
  ADD COLUMN IF NOT EXISTS directors_report_exempt_section_415a TINYINT(1) NOT NULL DEFAULT 1
    CHECK (directors_report_exempt_section_415a IN (0, 1))
    AFTER members_have_not_required_audit,
  ADD COLUMN IF NOT EXISTS profit_loss_not_delivered_section_444 TINYINT(1) NOT NULL DEFAULT 1
    CHECK (profit_loss_not_delivered_section_444 IN (0, 1))
    AFTER directors_report_exempt_section_415a;
...
ALTER TABLE ixbrl_fact_mappings
  MODIFY COLUMN calculation_type enum(
    ...
    'inverse_disclosure_statement','directors_report_signing_date',
...
(
  ...
  'http://xbrl.frc.org.uk/reports/2026-01-01/direp',
  'StatementThatDirectorsReportHasBeenPreparedInAccordanceWithProvisionsSmallCompaniesRegime',
  'Directors Report small companies regime statement',
  'text', 'inverse_disclosure_statement', 'directors_report_exempt_section_415a', 1,
  'duration', NULL, NULL, 'duration', NULL, 0, 0, 352, 1
),
(
  ...
  'Section 444(5A) profit and loss non-delivery election',
  'text', 'disclosure_statement', 'profit_loss_not_delivered_section_444', 1,
  'duration', NULL, NULL, 'duration', NULL, 0, 0, 351, 1
),
(
  ...
  'Date signing Directors Report',
  'date', 'directors_report_signing_date', 'accounts_approval_date', 1,
  'instant', NULL, NULL, 'instant_end', NULL, 0, 0, 353, 1
),
(
  ...
  'text', 'directors_report_marker', 'approving_director_name', 1,
  'duration', NULL, NULL, 'duration_director_1',
  '{"bus:EntityOfficersDimension":"bus:Director1"}', 0, 0, 354, 1
)
