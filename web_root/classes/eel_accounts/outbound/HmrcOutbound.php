...
final class HmrcOutbound implements \eel_accounts\Service\VatValidationInterfaceService
{
    ...
    public function validate(string $countryCode, string $vatNumber): \eel_accounts\Service\VatValidationResultService
    {
