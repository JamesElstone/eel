...
final class ActivityFeedService
{
    public function __construct(
        private readonly ?\eel_accounts\Repository\AccountingAuditRepository $auditRepository = null,
    ...
    public function fetchRecentActivity(int $companyId = 0, int $accountingPeriodId = 0, int $limit = 12, string $window = '7_days'): array
    {
        ...
        $auditRepository = $this->auditRepository ?? new \eel_accounts\Repository\AccountingAuditRepository();
