        ...
        if ($targetType === self::TARGET_COMPUTATION
            ...
            return [
                ...
                'mappings' => [
                    ...
                    ['canonical_key' => 'computation.summary.loss_restriction.post_2017_trading_losses.brought_forward', 'local_name' => 'TradingLossesBroughtForward', 'context_profile' => self::CONTEXT_HMRC_CT_COMPANY],
                    ['canonical_key' => 'computation.summary.loss_restriction.post_2017_trading_losses.used', 'local_name' => 'TradingLossesBroughtForwardAmountUsedAgainstTotalProfits', 'context_profile' => self::CONTEXT_HMRC_CT_COMPANY],
