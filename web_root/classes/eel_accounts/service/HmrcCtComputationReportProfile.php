...
final class HmrcCtComputationReportProfile
{
    ...
    private function mainPoolSchedule(array $filing, array $summary, \Closure $synthetic): array
    {
        ...
        $rows = [
            ...
            $this->row('main_pool_aia_qualifying_expenditure', 'report.main_pool.aia_qualifying_expenditure', 'Additions qualifying for AIA', 'normal', 'ct_period', 'frozen_main_pool_aia_qualifying_expenditure'),
            ...
            $this->plainRow('main_pool_aia_limit', 'AIA limit', $aiaLimit, 'published_aia_limit_for_ct_period'),
            ...
            $this->plainRow('main_pool_wda_rate', 'Writing Down Allowance (WDA) rate', $wdaRate, 'published_main_pool_wda_rate', 'percent'),
            ...
            $this->row('main_pool_total_fya_and_wda', 'report.main_pool.total_fya_and_wda', 'Total First Year Allowance (FYA) and WDA claimed for the main pool', 'normal', 'ct_period', 'frozen_main_pool_total_fya_and_wda'),
