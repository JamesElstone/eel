...
final class VatRegistrationService
{
    ...
    public function __construct(\eel_accounts\Service\VatValidationInterfaceService ...$validators) {
    ...
    public function validate(array $settings): \eel_accounts\Service\VatValidationResultService {
        ...
        return \eel_accounts\Service\VatValidationResultService::error('unknown', 'This VAT country/prefix is not supported yet.');
    }
    ...
    public function compareHmrcAndCompaniesHouse(array $settings, \eel_accounts\Service\VatValidationResultService $result): array {
        $warnings = [];
