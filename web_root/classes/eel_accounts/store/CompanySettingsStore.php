...
final class CompanySettingsStore
{
    ...
    public static function definitions(): array {
        return [
            ...
            'dividends_payable_nominal_id' => ['type' => 'int', 'default' => ''],
            'default_expense_charge_nominal_id' => ['type' => 'int', 'default' => ''],
            'tools_equipment_asset_cost_nominal_id' => ['type' => 'int', 'default' => ''],
            'tools_equipment_accum_dep_nominal_id' => ['type' => 'int', 'default' => ''],
            'plant_machinery_asset_cost_nominal_id' => ['type' => 'int', 'default' => ''],
            'plant_machinery_accum_dep_nominal_id' => ['type' => 'int', 'default' => ''],
            'motor_vehicle_asset_cost_nominal_id' => ['type' => 'int', 'default' => ''],
            'motor_vehicle_accum_dep_nominal_id' => ['type' => 'int', 'default' => ''],
            'van_asset_cost_nominal_id' => ['type' => 'int', 'default' => ''],
            'van_accum_dep_nominal_id' => ['type' => 'int', 'default' => ''],
    ...
    private function deserialiseValue(string $type, mixed $value): mixed
    {
        ...
        // Normalise string once
        $stringValue = trim((string)$value);

        return match ($type) {

            'bool' => in_array(strtolower($stringValue), ['1', 'true', 'yes', 'on'], true),

            'int' => is_numeric($stringValue)
                ? (int)$stringValue
                : 0,

            'char' => $stringValue,

            default => $stringValue, // fallback safety net
        };
    }
