...
final class DashboardRepository
{
    ...
    ): array
    {
        ...
        if ($defaultBankNominalId === null) {
            $defaultBankNominalId = (int)((new CompanySettingsStore($companyId))->all()['default_bank_nominal_id'] ?? 0);
        }
    ...
    {
        return $this->setupHealthContextToActionItems((new SetupHealthService())->buildContext($companyId));
    }
