...
final class CompanyAccountService
{
    ...
    private function normaliseInput(array $post): array {
        ...
        $input = [
            ...
            'nominal_account_id' => (new CompanyAccountNominalService())->normaliseNominalId($post['nominal_account_id'] ?? null),
    ...
    private function validateInput(int $companyId, array $input, ?int $accountId = null): array {
        ...
        $errors = array_merge(
            $errors,
            (new CompanyAccountNominalService())->validateNominalForAccountType(
