...
final class FileCheckService
{
    ...
    public function __construct(?array $uploads = null, ?CompanyRepository $companyRepository = null, ?Closure $companyNumberResolver = null)
    {
        if ($uploads === null) {
    ...
    private function companyPathSegment(int $companyId): string
    {
        ...
        if ($this->companyNumberResolver !== null) {
            ...
            $company = ($this->companyRepository ?? new CompanyRepository())->fetchCompanyDetails($companyId);
