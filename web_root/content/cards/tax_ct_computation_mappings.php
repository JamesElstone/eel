...
final class _tax_ct_computation_mappingsCard extends CardBaseFramework
{
    ...
    public function render(array $context): string
    {
        ...
        foreach ($packages as $package) { $html .= '<option value="' . (int)$package['id'] . '">' . \eel_accounts\Support\Utf8::html((string)$package['taxonomy_version'] . ' / ' . (string)$package['artifact_version']) . '</option>'; }
