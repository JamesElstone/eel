...
final class _tax_ct_computation_mappingsCard extends CardBaseFramework
{
    ...
    public function render(array $context): string
    {
        ...
        foreach ($profiles as $p) {
            ...
            $buttons = '';
            foreach ($actions as $intent => $label) { $buttons .= '<form method="post" data-ajax="true" style="display:inline">' . $hidden($intent) . '<input type="hidden" name="profile_id" value="' . (int)$p['id'] . '"><button class="button button-inline" type="submit">' . $label . '</button></form> '; }
