...
final class _tax_ct_period_factsCard extends CardBaseFramework
{
    ...
    public function render(array $context): string
    {
        ...
        $html = '<section class="settings-stack" id="ct-period-facts"><div class="helper">Enter the number of associated companies excluding this company. The application uses 0 until you change it. The associated-company counts are reviewed and approved together in the Year End Tax Readiness review.</div>';
