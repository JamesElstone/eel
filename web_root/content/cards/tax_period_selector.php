...
final class _tax_period_selectorCard extends CardBaseFramework
{
    ...
    private function periodSummary(array $company, array $ctPeriods, int $selectedCtPeriodId): string
    {
        ...
        foreach ($ctPeriods as $period) {
            ...
            return '<div class="summary-grid tax-period-selector-summary-grid">'
                . '<form method="post" action="?page=corporation_tax" data-ajax="true" class="summary-card tax-period-selector-summary-card">
