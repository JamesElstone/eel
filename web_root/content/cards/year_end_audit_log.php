...
final class _year_end_audit_logCard extends CardBaseFramework
{
    ...
    public function services(): array
    {
        return [
            [
                'key' => 'year_end_audit_rows',
                'service' => AccountingAuditRepository::class,
                'method' => 'fetchRecentYearEndAudit',
                'params' => [
                    'limit' => 200,
                ],
            ],
    ...
    {
        $rows = (array)(($context['services'] ?? [])['year_end_audit_rows'] ?? []);
        ...
        return '
            ...
            ' . $this->paginationControls($context, $pagination, 'Year-end audit events') . '
        ';
    }
