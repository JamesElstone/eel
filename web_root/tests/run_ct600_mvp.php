...
$patterns = [
    ...
    'test_HmrcCtFilingApprovalService.php',
    ...
    'test_IxbrlFilingApprovalWorkflowService.php',
    'test_IxbrlArtifactPersistence.php',
    'test_IxbrlAuthorityProfile*.php',
    'test_IxbrlAuthorityValidationService.php',
