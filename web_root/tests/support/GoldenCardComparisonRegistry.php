...
final class GoldenCardComparisonRegistry
{
    ...
    public static function selectedPages(): array
    {
        return [
            ...
            'loans' => ['director_loan_state', 'director_loan_terms', 'director_loan_attribution', 'director_loan_s455', 'director_loan_ct600a', 'loan_review', 'year_end_loan_confirmation'],
