...
final class GoldenCardComparisonRegistry
{
    ...
    {
        return [
            'assets' => ['asset_register', 'asset_create', 'asset_reconcile_manual', 'asset_relationships', 'not_an_asset'],
            ...
            'loans' => ['director_loan_state', 'director_loan_terms', 'director_loan_attribution', 'director_loan_s455', 'director_loan_ct600a', 'director_loan_filing_evidence', 'loan_review', 'year_end_loan_confirmation'],
            ...
            'transmit' => ['hmrc_transmit', 'companies_house_transmit', 'govtalk_transmission_history', 'govtalk_exchanges'],
            ...
            'profit_loss' => ['pl_summary', 'pl_trading', 'pl_monthly_trend', 'pl_income_breakdown', 'pl_expense_breakdown', 'pl_net_profit_bridge', 'pl_source_coverage', 'reserve_review', 'year_end_profit_loss_confirm'],
            'source_accounts' => ['banking_accounts', 'banking_reconciliation', 'banking_account_form', 'statement_field_mapping'],
            'corporation_tax' => ['tax_period_selector', 'tax_corporation_tax_summary', 'tax_taxable_profit_bridge', 'tax_prepayment_treatment', 'tax_disallowable_add_backs', 'tax_charitable_donations', 'tax_capital_add_backs', 'tax_depreciation_add_back', 'tax_capital_allowances_summary', 'tax_aia_allocation', 'tax_main_rate_pool', 'tax_special_rate_pool', 'tax_car_co2_treatment', 'tax_disposals_balancing', 'tax_losses', 'tax_rate_bands', 'tax_warnings', 'tax_ct_period_facts', 'corporation_tax_review', 'year_end_tax_readiness'],
            'tax_audit' => ['tax_audit_areas', 'tax_audit_detail'],
            'artefacts' => ['tax_artifacts_refresh', 'tax_treatment_rules', 'tax_rates_ct', 'tax_rates_ct600_rim', 'tax_frc_taxonomy', 'tax_arelle_download', 'tax_companies_house_accounts_schemas', 'tax_rates_vat', 'tax_thresholds_vat'],
            'filing_mappings' => ['tax_ct600_rim_mappings', 'tax_ct_computation_mappings'],
            ...
            'year_end' => ['year_end_checklist', 'year_end_notes', 'year_end_state', 'year_end_audit_log', 'year_end_evidence_bundles'],
        ];
    }
    ...
    public static function exclusions(): array
    {
        return [
            ...
            'director_loan_ct600a' => 'Tax evidence, classification and declaration workflow.',
            'director_loan_filing_evidence' => 'Immutable filing-evidence status and navigation.',
            ...
            'tax_artifacts_refresh' => 'Action-only tax artefact refresh workflow.',
        ];
    }
