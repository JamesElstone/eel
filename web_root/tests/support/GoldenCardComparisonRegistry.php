...
final class GoldenCardComparisonRegistry
{
    ...
    public static function selectedPages(): array
    {
        return [
            ...
            'incorporation' => ['incorporation_status', 'incorporation_share_capital', 'incorporation_add_shares', 'incorporation_payment_matching', 'incorporation_ownership_parties'],
