...
final class GoldenCardComparisonRegistry
{
    ...
    public static function selectedPages(): array
    {
        return [
            ...
            'director_loans' => ['director_loan_state', 'director_loan_directors', 'year_end_director_loan_offset'],
            ...
            'HMRC' => ['hmrc_obligations_summary', 'hmrc_obligations_action_panel', 'hmrc_obligations_timeline', 'hmrc_obligations_period_checklist', 'hmrc_fines_table', 'hmrc_submission_overview', 'hmrc_submission_controls', 'hmrc_submission_log', 'hmrc_submission_history'],
            'incorporation' => ['incorporation_status', 'incorporation_share_capital', 'incorporation_add_shares', 'incorporation_payment_matching'],
            'ixbrl_builder' => ['ixbrl_readiness', 'ixbrl_accounts_disclosures', 'ixbrl_accounts_mapping', 'ixbrl_facts_preview', 'ixbrl_generation'],
            ...
            'tax' => ['tax_period_selector', 'tax_corporation_tax_summary', 'tax_taxable_profit_bridge', 'tax_prepayment_treatment', 'tax_disallowable_add_backs', 'tax_capital_add_backs', 'tax_depreciation_add_back', 'tax_capital_allowances_summary', 'tax_aia_allocation', 'tax_main_rate_pool', 'tax_special_rate_pool', 'tax_car_co2_treatment', 'tax_disposals_balancing', 'tax_losses', 'tax_rate_bands', 'tax_warnings', 'year_end_tax_readiness'],
    ...
    public static function semanticContracts(): array
    {
        return [
            ...
            'tax_capital_add_backs' => ['page' => 'tax', 'result' => 'corporation_tax'],
