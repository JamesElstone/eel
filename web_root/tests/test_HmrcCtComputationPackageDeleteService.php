...
(new GeneratedServiceClassTestHarness())->run(
    \eel_accounts\Service\HmrcCtComputationPackageDeleteService::class,
    static function (GeneratedServiceClassTestHarness $harness, \eel_accounts\Service\HmrcCtComputationPackageDeleteService $service): void {
