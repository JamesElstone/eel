...
function ixbrlRenderFixtureFacts(): array
{
    return [
        ...
        ixbrlRenderFact('no_director_advances_or_credits', 'direp:GeneralDescriptionAdvancesCreditsToDirectorsIncludingTermsInterestRates', 'text', null, 'The company made no advances or credits to directors.', null, null, null, 'current_period_duration'),
