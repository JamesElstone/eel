...
$harness->run(\eel_accounts\Service\VatSupportScopeService::class, static function (
    ...
    $harness->check(\eel_accounts\Service\VatSupportScopeService::class, 'both CT600 builders fail closed without an approved frozen filing basis', static function () use ($harness): void {
        GoldenAccountsFixture::build();
        InterfaceDB::beginTransaction();
        $expectedPath = '';
        try {
